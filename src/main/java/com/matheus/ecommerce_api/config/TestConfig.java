...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2025-06-20T19:53:06Z"), u1);

        // Segundo pedido (3 dias depois)
        Order o2 = new Order(null, Instant.parse("2025-06-23T15:42:10Z"), u2);

        // Terceiro pedido (mesmo dia que o segundo, mas mais tarde)
        Order o3 = new Order(null, Instant.parse("2025-06-23T21:15:22Z"), u1);
